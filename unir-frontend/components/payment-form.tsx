...
export function PaymentForm({ apartment, bookingData }: PaymentFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("[v0] Processing payment:", {
      ...
      bookingData,
      paymentMethod,
      paymentData: paymentMethod === "card" ? cardData : { email: paypalEmail },
    })
  ...
  return (
    <Card className="border-border">
      <CardContent className="p-6">
        <h2 className="mb-6 text-xl font-bold text-foreground">Información de pago</h2>
        ...
        <Tabs value={paymentMethod} onValueChange={(v) => setPaymentMethod(v as "card" | "paypal")}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TabsContent value="paypal" className="space-y-6 mt-0">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-center py-8">
                  <svg className="h-12 w-auto" viewBox="0 0 124 33" fill="none">
                    <path
            ...
            <div className="rounded-lg bg-muted p-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="mb-1 font-semibold text-foreground">Pago seguro</h4>
            ...
            <p className="text-center text-xs text-muted-foreground mt-4">
              Al hacer clic en el botón, aceptas las políticas de cancelación del anfitrión y las reglas básicas para
              huéspedes
            </p>
          </form>
        </Tabs>
